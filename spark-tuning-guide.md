...
| **권장값** | `4` |
| 근거 수준 | 📘 일반적 관행 ([Cloudera 공식 문서](https://docs.cloudera.com/runtime/7.3.1/tuning-spark/spark-tuning.pdf): 5코어 이하 권장) |
...
- [Cloudera: Tuning Apache Spark Applications](https://docs.cloudera.com/runtime/7.3.1/tuning-spark/spark-tuning.pdf) — executor-cores 5 이하 권장 (*"At most, five tasks per executor can achieve full write throughput"*)
