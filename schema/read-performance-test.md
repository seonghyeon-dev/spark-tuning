...
| 항목 | Hive-raw (as-is) | Hive-orc (as-is) | A안 | B안 |
|------|-----------------|-----------------|-----|-----|
...
- **ts 필터 기준**: A안은 `day(ts)` 파티션에 맞춰 day 단위, B안은 `hour(ts)` 파티션에 맞춰 hour 단위로 고정
...
| Hive-raw (as-is) | Hive-orc (as-is) | A안 | B안 |
|-----------------|-----------------|-----|-----|
| (캡처) | (캡처) | (캡처) | (캡처) |
...
| 회차 | Hive-raw (as-is) | Hive-orc (as-is) | A안 | B안 |
|------|-----------------|-----------------|-----|-----|
| 1회 | | | | |
| 2회 | | | | |
| 3회 | | | | |
...
| 테스트 케이스 | Hive-raw (as-is) | Hive-orc (as-is) | A안 | B안 |
|-------------|-----------------|-----------------|-----|-----|
| 쿼리 1 — 조건 A | | | | |
| 쿼리 1 — 조건 B | | | | |
| 쿼리 2 — 조건 A | | | | |
