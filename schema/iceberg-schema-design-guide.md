...
- [3. Sort Order 설계](#3-sort-order-설계) — 정렬 효과, distribution-mode, 트레이드오프
- [4. Bucket](#4-bucket) — bucket 트랜스폼, 적용 시나리오
...
> 참고: [Iceberg Partitioning](https://iceberg.apache.org/docs/1.10.1/partitioning/) · [Partition Transforms Spec](https://iceberg.apache.org/spec/#partition-transforms)
...
> |-------------|-------------|
> | ![Before Compaction](https://cdn.prod.website-files.com/6772770a5e5d008a7b3c6a91/67a99dbd4ef074c15c26eaba_11.png) | ![After Compaction](https://cdn.prod.website-files.com/6772770a5e5d008a7b3c6a91/67a99dcfc8b7a8746c3a5fb0_12.png) |
...
> 참고: [Iceberg Partition Evolution](https://iceberg.apache.org/docs/1.10.1/evolution/#partition-evolution) · [rewrite_data_files Procedure](https://iceberg.apache.org/docs/1.10.1/spark-procedures/#rewrite_data_files)
...
> 참고: [Iceberg Spark Writes — Distribution Modes](https://iceberg.apache.org/docs/1.10.1/spark-writes/#distribution-modes) · [Spark DDL — WRITE ORDERED BY](https://iceberg.apache.org/docs/1.10.1/spark-ddl/#alter-table--write-ordered-by)

### 3.0 Sort Order이 필요한가?
...
> | none | hash | range |
> |------|------|-------|
> | ![none mode](https://www.guptaakashdeep.com/content/images/2025/03/image-6.png) | ![hash mode](https://www.guptaakashdeep.com/content/images/2025/03/image-2.png) | ![range mode](https://www.guptaakashdeep.com/content/images/2025/03/image-3.png) |
...
> 참고: [Iceberg Spark Procedures — rewrite_data_files](https://iceberg.apache.org/docs/1.10.1/spark-procedures/#rewrite_data_files)
...
![Z-curve](https://upload.wikimedia.org/wikipedia/commons/3/30/Z-curve.svg)
...
> 참고: [Iceberg Table Configuration — Parquet](https://iceberg.apache.org/docs/1.10.1/configuration/#write-properties)
...
| `write.distribution-mode` | `hash` | `range` | Sort Order 사용 시 `range` 필수 (3.2절 참조) |
...
![Parquet File Layout](https://raw.githubusercontent.com/apache/parquet-format/master/doc/images/FileLayout.gif)
...
> 참고: [Iceberg Configuration — write.target-file-size-bytes](https://iceberg.apache.org/docs/1.10.1/configuration/#write-properties) · [AWS Prescriptive Guidance — Iceberg Read Optimization](https://docs.aws.amazon.com/prescriptive-guidance/latest/apache-iceberg-on-aws/best-practices-read.html)
...
- [Iceberg Evolution (Partition Evolution)](https://iceberg.apache.org/docs/1.10.1/evolution/#partition-evolution)
