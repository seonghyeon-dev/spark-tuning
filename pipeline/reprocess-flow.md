...
[독립]  check_zombie_jobs
  ...
  │    WAIT_SCHEDULING  전날 03:00 이전만 (이후는 append 담당)
...
재처리는 03:00에 수 분간 돌고 append는 그 동안에도 약 5분 주기로 뜬다. 같은 테이블에 두 Spark job이 동시에 적재를 시도할 수 있으나 **문제가 없다.**
